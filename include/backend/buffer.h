...
class Buffer {
  ...
  public:
     ...
     * @return The content of the line. Returns an empty string if the index is
     * invalid.
     */
    ...
    /**
     * @brief Merges the current line with the line below at the specified
     * position.
     *
    ...
    /**
     * @brief Replaces all occurrences of a substring in a specific line with a
     * new substring.
     *
     * @param line_number The zero-based line number where replacements should
     * occur.
